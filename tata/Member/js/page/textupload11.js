(function(root, factory) {
	...
	function createBox($fileInput, file, webUploader) {
		...
		if ($parentFileBox.length <= 0) {
			var div = '<div class="parentFileBox am-u-sm-12"> '+
			'<ul data-am-widget="gallery" class="am-gallery am-avg-sm-2 am-avg-md-4 am-avg-lg-5 am-gallery-default am-no-layout fileBoxUl"></ul>'+
			'</div>';
		...
		if ($parentFileBox.find('.diyButton').length <= 0) {
			var div = '<div class="diyButton"> \
					<a class="diyStart am-btn" href="javascript:void(0)">开始上传</a> \
					<a class="diyCancelAll am-btn" href="javascript:void(0)">全部取消</a> \
				</div>';
