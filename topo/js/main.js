...
require.config({
	paths: { // -- 配置别名
		"jquery": ["//cdn.bootcss.com/jquery/3.4.1/jquery.min", "../assets/js/jquery.min"],
		"amazeui": ["//cdn.bootcss.com/amazeui/2.7.2/js/amazeui.min", "../assets/js/amazeui.min"],
...
require(["topo", "vue", "jquery", "amazeui", "layer", "gsPlugs", "jscolor"], function(TOPO, Vue, $) {
	...
	$(function() { // 总体内容
		...
		// 根据参数，改变 jtopo 
		var topoParam = $.gsPlugs.getUrlParam() || { type: "edit" };
