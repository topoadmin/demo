...
jQuery.farbtastic = function(container, callback) {
	...
	return container.farbtastic || (container.farbtastic = new jQuery._farbtastic(container,
		callback));
}
...
jQuery._farbtastic = function(container, callback) {
	...
	fb.mousedown = function(event) {
		...
		if (!document.dragging) {
			$(document).bind('mousemove', fb.mousemove).bind('mouseup',
				fb.mouseup);
